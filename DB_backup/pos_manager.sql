...
CREATE TABLE `manager` (
  ...
  `managerPasswd` varchar(12) NOT NULL,
  `managerName` varchar(4) NOT NULL,
  `managerGender` char(2) NOT NULL,
  `managerBirth` date DEFAULT NULL,
...
INSERT INTO `manager` VALUES (1,'m','1','매니저','남자',NULL,NULL,NULL);
