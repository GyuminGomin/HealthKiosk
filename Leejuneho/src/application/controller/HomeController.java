...
public class HomeController implements Initializable {
    ...
    private VBox panel;
    @FXML
    private Label loginManager, totalUser, allUser;
    @FXML
    private ProgressBar allUserBar; 
	...
	public void initialize(URL location, ResourceBundle resources) {
        ...
        // ProgressBar 전체 회원 수
        double maxValue = 12;
        allUserBar.setProgress(0.0);
        double progress = dao.countUser() / maxValue;
        allUserBar.setProgress(progress);
		String countUser1 = "만료를 포함한 등록된 회원은 총 " +dao.countUser()+ "명 입니다";
		allUser.setText(countUser1);
